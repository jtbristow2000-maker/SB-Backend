...
const S: Record<string, CSSProperties> = {
  ...
  note: { marginTop: 16, padding: "20px 16px", borderRadius: 14, background: "var(--surface)", border: "1px solid var(--border)", boxShadow: "var(--shadow-sm)", color: "#3c414b", textAlign: "center" },
  ...
  divider: { fontSize: 11, fontWeight: 700, letterSpacing: 0.5, color: "#8a909c", textTransform: "uppercase", borderTop: "1px solid var(--border)", paddingTop: 12, marginTop: 2 },
