...
const S: Record<string, CSSProperties> = {
  ...
  recTime: { fontSize: 13, fontWeight: 600, color: "var(--text)" },
  ...
  discard: { padding: "9px 14px", borderRadius: 9, border: "1px solid var(--border-strong)", background: "var(--surface)", color: "var(--text)", fontWeight: 600, fontSize: 13, cursor: "pointer" },
