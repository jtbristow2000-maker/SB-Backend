...
- 2026-06-08: Phase 3 richer customer profiles:
  ...
  - DONE (Codex, 2026-06-08): Extended AI voicemail extraction to capture explicit vehicle, preferred-contact, address/PO-box, and referral-source details, then fill only blank customer profile fields during intake without overwriting owner edits.
